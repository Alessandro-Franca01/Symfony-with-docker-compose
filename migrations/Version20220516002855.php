 ...
 */
final class Version20220516002855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, client_id INT NOT NULL, quantities INT DEFAULT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
